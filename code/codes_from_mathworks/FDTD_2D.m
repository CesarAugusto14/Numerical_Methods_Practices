...
f0         = 10e6;             % Frequency of Source        [Hertz]
Lf         = 10;              % Divisions per Wavelength   [unitless]
[Lx,Ly]    = deal(10,10);       % Wavelengths x,y            [unitless]
...
dt = (dx^-2+dy^-2)^-.5/c0*.999;  % Time step CFL condition [second]
...
tic    
    ...
    %% Plot
    imagesc(x,y,Ez); colormap jet; shading interp; drawnow; 
toc
end